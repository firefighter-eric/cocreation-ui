...
- 右侧以聊天式故事流展示当前共创过程
- 右上角支持打开设置抽屉，修改完整 `system prompt`、创作风格、`model`、`temperature`、`top_p`、`max_tokens` 和模式1回复延迟倍率
- 设置抽屉中的修改会自动保存，底部提供“还原默认”按钮
...
- `模式1`：流程与手动模式一致，但前台按“对方”语义呈现
- `模式2`：先点“开始”，再由你输入一句、AI 续写一句
- `模式3`：输入 `1-10` 轮，自动生成一组示例对话
